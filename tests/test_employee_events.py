...
def test_db_exists(db_path):
    ...
    assert db_path.is_file(), f"SQLite DB not found at {db_path}"
...
def test_employee_table_exists(table_names):
    ...
    assert "employee" in table_names, "'employee' table missing"
...
def test_team_table_exists(table_names):
    ...
    # is in the table_names list
    assert "team" in table_names, "'team' table missing"
...
def test_employee_events_table_exists(table_names):
    ...
    # is in the table_names list
    assert "employee_events" in table_names, "'employee_events' table missing"
